...
const ShoppingCartOverview = () => {
    ...
    console.log('Translation for total:', t('shoppingCart.total'));
    console.log('All translations:', t('shoppingCart', { returnObjects: true }));
                            ...
                            <div className="order-summary p-4 bg-gray-200 rounded-lg shadow-sm lg:col-span-1">
                                ...
                                <ul>
                                    ...
                                    <li className="flex justify-between font-bold text-lg">
                                        ...
                                        <span>
                                            €{((shoppingcart.totalPrice || 0) + 4.0).toFixed(2)}
                                        </span>
                                    </li>
                                </ul>
                                <button
